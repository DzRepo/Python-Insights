...
def get_groupings():
    groupings = {
        ...
        "user-tv-show": {"group_by": ["user.tv.show"]},
        ...
        "user-gender-user-age": {"group_by": ["user.gender", "user.age"]},
        ...
        "user-gender-user-tv-show": {"group_by": ["user.gender", "user.tv.show"]},
        ...
        "user-age-user-gender": {"group_by": ["user.age", "user.gender"]},
        "user-age-user-language": {"group_by": ["user.age", "user.language"]},
        "user-age-user-interest": {"group_by": ["user.age", "user.interest"]},
        "user-age-user-location-country": {"group_by": ["user.age", "user.location.country"]},
        "user-age-user-location-region": {"group_by": ["user.age", "user.location.region"]},
        "user-age-user-location-metro": {"group_by": ["user.age", "user.location.metro"]},
        "user-age-user-tv-genre": {"group_by": ["user.age", "user.tv.genre"]},
        "user-age-user-tv-show": {"group_by": ["user.age", "user.tv.show"]},
        "user-age-user-device-os": {"group_by": ["user.age", "user.device.os"]},
        "user-age-user-device-network": {"group_by": ["user.age", "user.device.network"]},
        "user-language-user-gender": {"group_by": ["user.language", "user.gender"]},
        "user-language-user-age": {"group_by": ["user.language", "user.age"]},
        ...
        "user-interest-user-age": {"group_by": ["user.interest", "user.age"]},
        ...
        "user-interest-user-tv-show": {"group_by": ["user.interest", "user.tv.show"]},
        ...
        "user-tv-genre-user-age": {"group_by": ["user.tv.genre", "user.age"]},
        ...
        "user-tv-show-user-gender": {"group_by": ["user.tv.show", "user.gender"]},
        "user-tv-show-user-age": {"group_by": ["user.tv.show", "user.age"]},
        "user-tv-show-os-user-language": {"group_by": ["user.tv.show", "user.language"]},
        "user-tv-show-user-interest": {"group_by": ["user.tv.show", "user.interest"]},
        "user-tv-show-user-tv-genre": {"group_by": ["user.tv.show", "user.tv.genre"]},
        "user-tv-show-user-location-country": {"group_by": ["user.tv.show", "user.location.country"]},
        "user-tv-show-user-location-region": {"group_by": ["user.tv.show", "user.location.region"]},
        "user-tv-show-user-location-metro": {"group_by": ["user.tv.show", "user.location.metro"]},
        "user-tv-show-user-device-network": {"group_by": ["user.tv.show", "user.device.network"]},
        "user-location-country-user-gender": {"group_by": ["user.location.country", "user.gender"]},
        "user-location-country-user-age": {"group_by": ["user.location.country", "user.age"]},
        ...
        "user-location-country-user-tv-show": {"group_by": ["user.location.country", "user.tv.show"]},
        ...
        "user-location-region-user-age": {"group_by": ["user.location.region", "user.age"]},
        ...
        "user-location-region-user-tv-show": {"group_by": ["user.location.region", "user.tv.show"]},
        ...
        "user-location-metro-user-age": {"group_by": ["user.location.metro", "user.age"]},
        ...
        "user-location-metro-user-tv-show": {"group_by": ["user.location.metro", "user.tv.show"]},
        ...
        "user-device-os-user-age": {"group_by": ["user.device.os", "user.age"]},
        ...
        "user-device-os-user-tv-show": {"group_by": ["user.device.os", "user.tv.show"]},
        ...
        "user-device-network-user-age": {"group_by": ["user.device.network", "user.gender"]},
        ...
        "user-device-network-user-tv-show": {"group_by": ["user.device.network", "user.tv.show"]},
